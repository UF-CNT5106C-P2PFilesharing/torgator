...
public class SystemConfiguration {
    ...
    public static final String peerInfoFile = System.getProperty("user.dir") + "/Configurations/PeerInfo.cfg";
    public static final String systemConfigurationFile = System.getProperty("user.dir") + "/Configurations/Common.cfg";
}
